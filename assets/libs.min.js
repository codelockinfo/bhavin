    ...
    (function (t, e) {
        ...
        var t = function (t, e, i, n) {
            ...
            var h,
                ...
                jt = null,
                Bt = function () {
                    jt && (r.unbind(document, "mousemove", Bt), r.addClass(t, "pswp--has_mouse"), (l.mouseUsed = !0), Ot("mouseUsed")),
                    ...
                    updateCurrItem: function (t) {
                        if (0 !== xt) {
                            ...
                            if (!(t && i < 2)) {
                                ...
                                for (var n = 0; n < i; n++)
                                    xt > 0
                                        ? ((e = S.shift()), (S[a - 1] = e), p++, Rt((p + 2) * _t.x, e.el.style), s.setContent(e, f - i + n + 1 + 1))
                ...
                Ne = function (t) {
                    ...
                    return (
                        D
                            ...
                            ? t.touches && t.touches.length > 0 && ((Fe[0] = De(t.touches[0], Re)), t.touches.length > 1 && (Fe[1] = De(t.touches[1], Ie)))
                ...
                Xe = function (t, e) {
                    ...
                    return (
                        ...
                        (rt
                            ...
                            : (o = u),
                        "x" === t)
                            ? (void 0 !== o && (It(o, !0), (K = o !== de.x)), nt.min.x !== nt.max.x && (void 0 !== r ? (mt.x = r) : K || (mt.x += e.x * i)), void 0 !== o)
                ...
                publicMethods: {
                    initGestures: function () {
                        ...
                        (D = X.pointerEvent),
                            ...
                            (v[E] = We),
                            O && (v[O] = v[E]),
                            X.touch && ((g += " mousedown"), (m += " mousemove mouseup"), (v.mousedown = v[C]), (v.mousemove = v[k]), (v.mouseup = v[E])),
                ...
                ii = function (e, i, n, o) {
                    ...
                    var d = function () {
                        ...
                        e.miniImg && (e.miniImg.style.webkitBackfaceVisibility = "hidden"),
                            n || ((y = a.w / e.w), (mt.x = a.x), (mt.y = a.y - I), (s[o ? "template" : "bg"].style.opacity = 0.001), zt()),
                            ee("initialZoom"),
                ...
                publicMethods: {
                    ...
                    setContent: function (t, e) {
                        ...
                        if ((!o.src && o.html && (o.html.tagName ? a.appendChild(o.html) : (a.innerHTML = o.html)), ui(o), li(o, gt), !o.src || o.loadError || o.loaded))
                            ...
                            o.loading || ci(o), s.allowProgressiveImg() && (!$e && X.transform ? ri.push({ item: o, baseDiv: a, img: o.img, index: e, holder: t }) : hi(e, o, a, o.img, !0, !0));
                        }
                    ...
                    if (
                        (("number" != typeof f || ("number" != typeof n && !d)) &&
                            (o || isNaN(f) || (!d && isNaN(n)) || "boolean" == typeof f || "boolean" == typeof n
                                ? ((p.fp = o), (h = j(f, d ? parseFloat(p.s) + p.c : n, a || M.defaultStringFilter, p)), (p = { t: h, p: "setRatio", s: 0, c: 1, f: 2, pg: 0, n: r || e, pr: 0, m: 0 }))
            ...
            (a._init = function () {
                ...
                (a._initProps = function (e, i, n, r, s) {
                    ...
                    return r && this._kill(r, e)
                        ...
                        : (this._firstPT && ((this.vars.lazy !== !1 && this._duration) || (this.vars.lazy && !this._duration)) && (I[e._gsTweenID] = !0), l);
                }),
                (a.render = function (t, e, i) {
                    var n,
                        r,
                    ...
                    if (this._time !== a || i) {
                        if (!this._initted) {
                            ...
                            if (!i && this._firstPT && ((this.vars.lazy !== !1 && this._duration) || (this.vars.lazy && !this._duration)))
                                return (this._time = this._totalTime = a), (this._rawPrevTime = h), R.push(this), void (this._lazy = [t, e]);
                    ...
                    if (((f.svg = !(!t.getCTM || !jt(t))), f.svg && (Ft(t, J(t, At, i, !1, "50% 50%") + "", f, t.getAttribute("data-svg-origin")), (Ct = o.useSVGTransformAttr || It)), (s = Ut(t)), s !== Bt)) {
                        if (16 === s.length) {
                            var y,
                                ...
                                N = s[11],
                                X = Math.atan2(O, z);
                            f.zOrigin && ((I = -f.zOrigin), (L = D * I - s[12]), (R = M * I - s[13]), (I = z * I + f.zOrigin - s[14])),
                                (f.rotationX = X * F),
                                X &&
                                    ((w = Math.cos(-X)),
                                    (b = Math.sin(-X)),
                                ...
                                (X = Math.atan2(-P, z)),
                                (f.rotationY = X * F),
                                X && ((w = Math.cos(-X)), (b = Math.sin(-X)), (y = T * w - D * b), (_ = S * w - M * b), (x = P * w - z * b), (M = S * b + M * w), (z = P * b + z * w), (N = C * b + N * w), (T = y), (S = _), (P = x)),
                                (X = Math.atan2(S, T)),
                                (f.rotation = X * F),
                                X && ((w = Math.cos(X)), (b = Math.sin(X)), (y = T * w + S * b), (_ = k * w + E * b), (x = D * w + M * b), (S = S * w - T * b), (E = E * w - k * b), (M = M * w - D * b), (T = y), (k = _), (D = x)),
                                ...
                                (S /= f.scaleX),
                                (E /= f.scaleY),
                                Math.abs(X) > p ? ((f.skewX = X * F), (k = 0), "simple" !== f.skewType && (f.scaleY *= 1 / Math.cos(X))) : (f.skewX = 0),
                            ...
                            (f.x = s[4] || 0),
                                ...
                                f.svg && ((f.x -= f.xOrigin - (f.xOrigin * B + f.yOrigin * W)), (f.y -= f.yOrigin - (f.xOrigin * U + f.yOrigin * Y)));
                        }
                        Math.abs(f.skewX) > 90 &&
